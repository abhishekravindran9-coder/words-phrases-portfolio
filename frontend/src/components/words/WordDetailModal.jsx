    ...
    <>
      ...
      <div
        ...
        className="fixed inset-0 sm:inset-y-0 sm:right-0 sm:left-auto z-50
                   w-full sm:w-[480px] bg-white flex flex-col
      ...
      >
        ...
        <div className="flex items-start justify-between px-5 pt-5 pb-4 border-b border-gray-100">
          <div className="flex-1 min-w-0 pr-3">
            ...
            <h2 className="mt-1 text-2xl font-extrabold text-gray-900 break-words leading-tight">
              {word.word}
            </h2>
            {word.categoryName && (
              <span
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
            ...
            <section>
              ...
              <ul className="space-y-3">
                {sentences.map((s, i) => (
                  <li
                    key={i}
                    className="relative pl-4 text-sm text-gray-700 italic leading-relaxed
          ...
          {word.notes && (
            <section>
              ...
              <p className="text-sm text-gray-700 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3 leading-relaxed whitespace-pre-wrap">
                {word.notes}
              </p>
            </section>
          )}
